export default function Customize ({ rearranging, setRearranging, setCoordsOfRearrangingApp, setShowStock }) {
    return <div className="text-zinc-100 z-30 absolute w-[70%] h-[55px] top-2 flex flex-row justify-center gap-4">
        ...
        <button className="bg-[#574e46] px-8 py-2 border-4 border-black rounded-md font-bold text-lg">Floors</button>
